...
export default function Home() {
  ...
  const handleWhatsAppOrder = (productName = "") => {
    const phone = "+6283196994741";
    const message = productName
      ? `Halo! Saya ingin bertanya mengenai produk ${productName}, bisa dibantu?`
      : "Halo! Saya ingin bertanya tentang produk UMKM AZAH BUCKET.";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div>
                <h1 className="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">UMKM AZAH BUCKET</h1>
                <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Kerajinan Bucket Kreatif</p>
              </div>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-4 leading-tight">
                UMKM Kreatif Spesialis Bucket<br />
                <span className="text-amber-600">AZAH BUCKET</span><br />
              ...
              <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700">
                <p className="flex items-start gap-2">
                  ...
                  Bucket handmade untuk hadiah dan hampers spesial
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-amber-600 font-semibold">✓</span>
                  Desain bebas sesuai permintaan pelanggan
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-amber-600 font-semibold">✓</span>
                  Estetik, personal, dan cocok untuk segala momen
                </p>
              </div>
            </div>
      ...
      <section id="produk" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
            Produk Estetik, personal, cocok untuk segala momen dan bebas sesuai permintaan
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base">+62 831-9699-4741</span>
                </div>
      ...
      <footer className="bg-gray-900 text-white py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <span className="text-base sm:text-lg font-semibold">UMKM AZAH BUCKET</span>
          </div>
          <p className="text-gray-400 text-xs sm:text-sm">
            © 2025 UMKM AZAH BUCKET. Dibuat dengan ❤️ untuk momen anda
          </p>
        </div>
      </footer>
